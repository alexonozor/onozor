...
(function() {
  ...
  jQuery(function() {
    return $('.help-toggle').click(function() {
      return $('.editing-help').slideToggle('fast');
    });
  });

  jQuery(function() {
    return $('.question-title').focus(function() {
      return $('.error-holder').addClass('has-error');
    });
  });

  jQuery(function() {
    return $('.post_form').focus(function() {
      return $('.editing-help').slideDown('slow');
    });
  });

  jQuery(function() {
    return $('.question-title').keydown(function() {
      if (this.value.length >= 10) {
        return $('.error-holder').removeClass('has-error');
      } else {
        return $('.error-holder').addClass('has-error');
      }
    });
